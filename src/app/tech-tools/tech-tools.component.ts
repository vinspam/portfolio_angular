...
export class TechToolsComponent {
  ...
  items: Array<any> = [
    ...
    },
    {
      name: 'Go',
      description:
        'Go, also known as Golang, is an open-source programming language developed by engineers at Google in 2007.',
      link: 'https://go.dev/',
    ...
    },
    {
      name: 'React',
      description:
        'React.js is a JavaScript library developed by Facebook for building dynamic and interactive user interfaces, particularly for single-page applications (SPAs).',
    ...
    },
    {
      name: 'Next',
      description:
        'It is a React-based framework that provides additional features and optimizations, allowing developers to build server-side rendered (SSR) and static websites.',
    ...
    },
    {
      name: 'MongoDB',
      description:
        'MongoDB is a NoSQL database designed for modern applications that require flexibility, scalability, and performance.',
